...
/**
 * CheckDeleteArticlePage component - Delete confirmation modal for article
 * Desktop-only modal dialog for confirming article deletion
 */
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="relative bg-white rounded-[16px] w-full max-w-[420px] mx-[16px] shadow-lg">
        <header className="relative px-[40px] pt-[32px] pb-[8px] text-center">
          ...
          <h2 className="text-headline-4 text-brown-600">Delete article</h2>
        </header>
